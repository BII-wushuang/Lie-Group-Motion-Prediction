...
y_loc = joint_xyz(:,:,2);
z_loc = joint_xyz(:,:,3);
x_min = floor(min(x_loc(:))/100)*100;
x_max = ceil(max(x_loc(:))/100)*100;
y_min = floor(min(y_loc(:))/100)*100;
y_max = ceil(max(y_loc(:))/100)*100;
z_min = floor(min(z_loc(:))/100)*100;
z_max = ceil(max(z_loc(:))/100)*100;
